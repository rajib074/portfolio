...
const Project = () => {
  return (
    <div>
      <section className="text-gray-600 body-font p-5 overflow-hidden">
        <div className="container px-5 py-4 mx-auto">
          ...
          <div className="flex flex-wrap m-4">
            <div className=" p-4 xl:w-1/3 text-center md:w-1/2 w-full">
              <a className="btn btn-info mb-3" href="https://vitacreact.web.app/">Live Link</a>
            ...
            <div className=" p-4 xl:w-1/3 text-center md:w-1/2 w-full">
            <a className="btn btn-info mb-3" href="https://teacher-3404a.web.app/">Live Link</a>
            ...
            <div className=" p-4 xl:w-1/3 text-center md:w-1/2 w-full">
            <a className="btn btn-info mb-3" href="https://rajib-enterprice.web.app/">Live Link</a>
