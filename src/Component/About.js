        ...
        <div className="hero min-h-screen">
          <div className="hero-content flex-col m-auto lg:flex-row">
            ...
            <div className="m-5 lg:w-96">
              ...
              <h1 className="text-2xl font-bold">I'M <br/> RAJIB SARKAR <br/> WEB DESIGNERA</h1>
              <p className="py-6">
              ...
              <br/>• React.js, React Bootstrap, Daisy UI,
React Query.
<br/>• Node.js, Express.js, MongoDB, JWT .
              </p>
              
              <h2 className="text-2xl font-bold">Education</h2>
              <p>Technical School & College Brahmanbaria<br/>
H.S.C(2014)
GPA 4.28 (Science). </p>
              
              <h2 className="text-2xl  font-bold">Contact</h2>
              <p className="text-blue-700">
                <a href="mailto:rajibsarkar074@gmail.com">rajibsarkar074@gmail.com</a><br/>
                <a href="https://www.facebook.com/rajib074">Facebook</a><br/>
                <a href="https://github.com/rajib074">GitHub</a><br/>
                <a href="https://www.linkedin.com/in/rajib-sarkar-193854140/">LinkedIn</a><br/>
